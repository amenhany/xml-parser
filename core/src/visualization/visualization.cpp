...
namespace xml_editor::draw {
    ...
    static const std::unordered_set<std::string> supported_formats = {
        "bmp","cgimage","eps","exr","fig","gd","gd2","gif","ico",
        "jpg","jpeg","jpe","jp2","pdf","pic","pct","pict","png",
        "ps","ps2","psd","sgi","svg","svgz","svg_inline","tga",
        "tif","tiff","wbmp","webp","xlib","x11"
    };
    ...
    void run_graphviz(const std::string& graph, const std::string& outputPath) {
        ...
        std::string command = "echo \"" + graph + "\" | dot -T" + extension + " -o " + outputPath;
